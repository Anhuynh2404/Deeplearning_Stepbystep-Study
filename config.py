...
def config_chapter2(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
        download_to_colab(2, branch)
        print('Finished!')

def config_chapter2_1(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
        download_to_colab(21, branch)
        print('Finished!')

def config_chapter3(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
        download_to_colab(3, branch)
        print('Finished!')

def config_chapter4(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
        download_to_colab(4, branch)
        print('Finished!')

def config_chapter5(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
...
def config_chapterextra(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
        download_to_colab(71, branch)
        print('Finished!')
        
def config_chapter8(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
        download_to_colab(8, branch)
        print('Finished!')
        
def config_chapter9(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
        download_to_colab(9, branch)
        print('Finished!')

def config_chapter10(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
        download_to_colab(10, branch)
        print('Finished!')

def config_chapter11(branch='main'):
    if IS_COLAB:
        print('Downloading files from GitHub repo to Colab...')
